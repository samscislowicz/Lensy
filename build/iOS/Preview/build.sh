#!/bin/bash
# This file was generated based on '/Users/Sam/Library/Application Support/Fusetools/Packages/UnoCore/1.0.11/targets/ios/build.sh'.
...
##else
    xcodebuild -project "LensyFinal.xcodeproj" "$@" | tee >(checkForError)
##endif
