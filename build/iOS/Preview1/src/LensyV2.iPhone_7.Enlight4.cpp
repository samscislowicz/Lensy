// This file was generated based on /Users/Sam/Desktop/Lensy/LensyFinal/build/iOS/Preview1/cache/ux11/LensyV2.iPhone_7.Enlight4.g.uno.
...
// public partial sealed class Enlight4 :4
// {
// static Enlight4() :6
static void Enlight4__cctor_3_fn(uType* __type)
{
}

static void Enlight4_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)Enlight4__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::Image_type* Enlight4_typeof()
{
    ...
    options.ObjectSize = sizeof(Enlight4);
    options.TypeSize = sizeof(::g::Fuse::Controls::Image_type);
    type = (::g::Fuse::Controls::Image_type*)uClassType::New("LensyV2.iPhone_7.Enlight4", options);
    type->fp_build_ = Enlight4_build;
    type->fp_ctor_ = (void*)Enlight4__New4_fn;
    type->fp_cctor_ = Enlight4__cctor_3_fn;
...
// public Enlight4() :10
void Enlight4__ctor_7_fn(Enlight4* __this)
{
    __this->ctor_7();
}

// private void InitializeUX() :14
void Enlight4__InitializeUX_fn(Enlight4* __this)
{
    __this->InitializeUX();
}

// public Enlight4 New() :10
void Enlight4__New4_fn(Enlight4** __retval)
{
    *__retval = Enlight4::New4();
}

// public Enlight4() [instance] :10
void Enlight4::ctor_7()
{
    uStackFrame __("LensyV2.iPhone_7.Enlight4", ".ctor()");
    ctor_6();
    InitializeUX();
}

// private void InitializeUX() [instance] :14
void Enlight4::InitializeUX()
{
    uStackFrame __("LensyV2.iPhone_7.Enlight4", "InitializeUX()");
    ...
    temp1->Density(1.0f);
    temp1->File(::g::Uno::UX::BundleFileSource::New1(::g::LensyFinal_bundle::iPhone_7Enlight41x21750f8f()));
    temp2->Density(2.0f);
    temp2->File(::g::Uno::UX::BundleFileSource::New1(::g::LensyFinal_bundle::iPhone_7Enlight42x2174fb0c()));
    Source(temp);
}

// public Enlight4 New() [static] :10
Enlight4* Enlight4::New4()
{
    Enlight4* obj1 = (Enlight4*)uNew(Enlight4_typeof());
    obj1->ctor_7();
    return obj1;
}
// }
