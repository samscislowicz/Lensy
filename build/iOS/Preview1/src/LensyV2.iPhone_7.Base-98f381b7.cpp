// This file was generated based on /Users/Sam/Desktop/Lensy/LensyFinal/build/iOS/Preview1/cache/ux11/LensyV2.iPhone_7.Base_Buttons.Line.g.uno.
...
::g::Fuse::Controls::Image_type* Line_typeof()
{
    ...
    type = (::g::Fuse::Controls::Image_type*)uClassType::New("LensyV2.iPhone_7.Base_Buttons.Line", options);
...
void Line::ctor_7()
{
    uStackFrame __("LensyV2.iPhone_7.Base_Buttons.Line", ".ctor()");
    ctor_6();
    InitializeUX();
}
...
{
    uStackFrame __("LensyV2.iPhone_7.Base_Buttons.Line", "InitializeUX()");
    ...
    temp1->Density(1.0f);
    temp1->File(::g::Uno::UX::BundleFileSource::New1(::g::LensyFinal_bundle::iPhone_7Base_ButtonsLine1x6b71b361()));
    temp2->Density(2.0f);
    temp2->File(::g::Uno::UX::BundleFileSource::New1(::g::LensyFinal_bundle::iPhone_7Base_ButtonsLine2xbc3e7ab2()));
    Source(temp);
}
