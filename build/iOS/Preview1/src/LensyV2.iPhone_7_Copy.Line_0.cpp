// This file was generated based on /Users/Sam/Desktop/Lensy/LensyFinal/build/iOS/Preview1/cache/ux11/LensyV2.iPhone_7_Copy.Line_0.g.uno.
...
::g::Fuse::Controls::Image_type* Line_0_typeof()
{
    ...
    type = (::g::Fuse::Controls::Image_type*)uClassType::New("LensyV2.iPhone_7_Copy.Line_0", options);
...
void Line_0::ctor_7()
{
    uStackFrame __("LensyV2.iPhone_7_Copy.Line_0", ".ctor()");
    ctor_6();
    InitializeUX();
}
...
{
    uStackFrame __("LensyV2.iPhone_7_Copy.Line_0", "InitializeUX()");
    ...
    temp1->Density(1.0f);
    temp1->File(::g::Uno::UX::BundleFileSource::New1(::g::LensyFinal_bundle::iPhone_7_CopyLine_01xfa7836c1()));
    temp2->Density(2.0f);
    temp2->File(::g::Uno::UX::BundleFileSource::New1(::g::LensyFinal_bundle::iPhone_7_CopyLine_02x495d7ba6()));
    Source(temp);
}
