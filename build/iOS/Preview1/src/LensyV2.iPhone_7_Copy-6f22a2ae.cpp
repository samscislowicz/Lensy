// This file was generated based on /Users/Sam/Desktop/Lensy/LensyFinal/build/iOS/Preview1/cache/ux11/LensyV2.iPhone_7_Copy.Base_Buttons.Line_0.g.uno.
...
namespace Base_Buttons{

// public partial sealed class Line_0 :4
// {
// static Line_0() :6
static void Line_0__cctor_3_fn(uType* __type)
{
}

static void Line_0_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)Line_0__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::Image_type* Line_0_typeof()
{
    ...
    options.ObjectSize = sizeof(Line_0);
    options.TypeSize = sizeof(::g::Fuse::Controls::Image_type);
    type = (::g::Fuse::Controls::Image_type*)uClassType::New("LensyV2.iPhone_7_Copy.Base_Buttons.Line_0", options);
    type->fp_build_ = Line_0_build;
    type->fp_ctor_ = (void*)Line_0__New4_fn;
    type->fp_cctor_ = Line_0__cctor_3_fn;
...
// public Line_0() :10
void Line_0__ctor_7_fn(Line_0* __this)
{
    __this->ctor_7();
}

// private void InitializeUX() :14
void Line_0__InitializeUX_fn(Line_0* __this)
{
    __this->InitializeUX();
}

// public Line_0 New() :10
void Line_0__New4_fn(Line_0** __retval)
{
    *__retval = Line_0::New4();
}

// public Line_0() [instance] :10
void Line_0::ctor_7()
{
    uStackFrame __("LensyV2.iPhone_7_Copy.Base_Buttons.Line_0", ".ctor()");
    ctor_6();
    InitializeUX();
}

// private void InitializeUX() [instance] :14
void Line_0::InitializeUX()
{
    uStackFrame __("LensyV2.iPhone_7_Copy.Base_Buttons.Line_0", "InitializeUX()");
    ...
    temp1->Density(1.0f);
    temp1->File(::g::Uno::UX::BundleFileSource::New1(::g::LensyFinal_bundle::iPhone_7_CopyBase_ButtonsLine_01xf39722dc()));
    temp2->Density(2.0f);
    temp2->File(::g::Uno::UX::BundleFileSource::New1(::g::LensyFinal_bundle::iPhone_7_CopyBase_ButtonsLine_02xf39726df()));
    Source(temp);
}

// public Line_0 New() [static] :10
Line_0* Line_0::New4()
{
    Line_0* obj1 = (Line_0*)uNew(Line_0_typeof());
    obj1->ctor_7();
    return obj1;
}
// }

}}}} // ::g::LensyV2::iPhone_7_Copy::Base_Buttons
