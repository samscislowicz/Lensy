// This file was generated based on /Users/Sam/Desktop/Lensy/LensyFinal/build/iOS/Preview1/cache/ux11/MainView.g.uno.
...
static void MainView__cctor_1_fn(uType* __type)
{
    ...
    ::g::Uno::UX::Resource::SetGlobalKey(::g::LensyV2::GeneratedClasses::SFUIText_Medium(), ::STRINGS[87/*"SFUIText_Me...*/]);
    ::g::Uno::UX::Resource::SetGlobalKey(::g::LensyV2::GeneratedClasses::SFUIDisplay_Bold(), ::STRINGS[88/*"SFUIDisplay...*/]);
    ::g::Uno::UX::Resource::SetGlobalKey(::g::LensyV2::GeneratedClasses::SFUIDisplay_Medium(), ::STRINGS[89/*"SFUIDisplay...*/]);
    ::g::Uno::UX::Resource::SetGlobalKey(::g::LensyV2::GeneratedClasses::Miciana_Regular(), ::STRINGS[90/*"Miciana_Reg...*/]);
    ::g::Uno::UX::Resource::SetGlobalKey(::g::LensyV2::GeneratedClasses::SFUIText_Semibold(), ::STRINGS[91/*"SFUIText_Se...*/]);
    ::g::Uno::UX::Resource::SetGlobalKey(::g::LensyV2::GeneratedClasses::SFUIText_Regular(), ::STRINGS[92/*"SFUIText_Re...*/]);
    ::g::Uno::UX::Resource::SetGlobalKey(::g::LensyV2::GeneratedClasses::SFUIText_LightItalic(), ::STRINGS[93/*"SFUIText_Li...*/]);
    ::g::Uno::UX::Resource::SetGlobalKey(::g::LensyV2::GeneratedClasses::SFUIText_Light(), ::STRINGS[94/*"SFUIText_Li...*/]);
}
...
static void MainView_build(uType* type)
{
    ...
    ::STRINGS[87] = uString::Const("SFUIText_Medium");
    ::STRINGS[88] = uString::Const("SFUIDisplay_Bold");
    ::STRINGS[89] = uString::Const("SFUIDisplay_Medium");
    ::STRINGS[90] = uString::Const("Miciana_Regular");
    ::STRINGS[91] = uString::Const("SFUIText_Semibold");
    ::STRINGS[92] = uString::Const("SFUIText_Regular");
    ::STRINGS[93] = uString::Const("SFUIText_LightItalic");
    ::STRINGS[94] = uString::Const("SFUIText_Light");
    ::STRINGS[95] = uString::Const("Home");
...
void MainView::InitializeUX()
{
    ...
    MainView__Template1* Settings = MainView__Template1::New2(this, this);
    MainView__Template2* Camera = MainView__Template2::New2(this, this);
    ...
    temp20->DefaultPath(::STRINGS[95/*"Home"*/]);
    ...
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp20->Templates()), ::TYPES[1/*Uno.Collections.ICollection<Uno.UX.Template>*/]), Settings);
    ::g::Uno::Collections::ICollection::Add_ex(uInterface(uPtr(temp20->Templates()), ::TYPES[1/*Uno.Collections.ICollection<Uno.UX.Template>*/]), Camera);
