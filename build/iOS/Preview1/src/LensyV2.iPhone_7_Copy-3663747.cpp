// This file was generated based on /Users/Sam/Desktop/Lensy/LensyFinal/build/iOS/Preview1/cache/ux11/LensyV2.iPhone_7_Copy.Warning_Symbol.Oval.g.uno.
...
namespace Warning_Symbol{

// public partial sealed class Oval :4
// {
// static Oval() :6
static void Oval__cctor_3_fn(uType* __type)
{
}

static void Oval_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)Oval__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::Image_type* Oval_typeof()
{
    ...
    options.ObjectSize = sizeof(Oval);
    options.TypeSize = sizeof(::g::Fuse::Controls::Image_type);
    type = (::g::Fuse::Controls::Image_type*)uClassType::New("LensyV2.iPhone_7_Copy.Warning_Symbol.Oval", options);
    type->fp_build_ = Oval_build;
    type->fp_ctor_ = (void*)Oval__New4_fn;
    type->fp_cctor_ = Oval__cctor_3_fn;
...
// public Oval() :10
void Oval__ctor_7_fn(Oval* __this)
{
    __this->ctor_7();
}

// private void InitializeUX() :14
void Oval__InitializeUX_fn(Oval* __this)
{
    __this->InitializeUX();
}

// public Oval New() :10
void Oval__New4_fn(Oval** __retval)
{
    *__retval = Oval::New4();
}

// public Oval() [instance] :10
void Oval::ctor_7()
{
    uStackFrame __("LensyV2.iPhone_7_Copy.Warning_Symbol.Oval", ".ctor()");
    ctor_6();
    InitializeUX();
}

// private void InitializeUX() [instance] :14
void Oval::InitializeUX()
{
    uStackFrame __("LensyV2.iPhone_7_Copy.Warning_Symbol.Oval", "InitializeUX()");
    ...
    temp1->Density(1.0f);
    temp1->File(::g::Uno::UX::BundleFileSource::New1(::g::LensyFinal_bundle::iPhone_7_CopyWarning_SymbolOval1x687424fd()));
    temp2->Density(2.0f);
    temp2->File(::g::Uno::UX::BundleFileSource::New1(::g::LensyFinal_bundle::iPhone_7_CopyWarning_SymbolOval2x6874207e()));
    Source(temp);
}

// public Oval New() [static] :10
Oval* Oval::New4()
{
    Oval* obj1 = (Oval*)uNew(Oval_typeof());
    obj1->ctor_7();
    return obj1;
}
// }

}}}} // ::g::LensyV2::iPhone_7_Copy::Warning_Symbol
