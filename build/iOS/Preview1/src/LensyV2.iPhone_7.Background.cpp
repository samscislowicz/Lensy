// This file was generated based on /Users/Sam/Desktop/Lensy/LensyFinal/build/iOS/Preview1/cache/ux11/LensyV2.iPhone_7.Background.g.uno.
...
::g::Fuse::Controls::Image_type* Background_typeof()
{
    ...
    type = (::g::Fuse::Controls::Image_type*)uClassType::New("LensyV2.iPhone_7.Background", options);
...
{
    uStackFrame __("LensyV2.iPhone_7.Background", ".ctor()");
    ctor_6();
    InitializeUX();
}
...
{
    uStackFrame __("LensyV2.iPhone_7.Background", "InitializeUX()");
    ...
    temp1->Density(1.0f);
    temp1->File(::g::Uno::UX::BundleFileSource::New1(::g::LensyFinal_bundle::iPhone_7Background1x43a75da6()));
    temp2->Density(2.0f);
    temp2->File(::g::Uno::UX::BundleFileSource::New1(::g::LensyFinal_bundle::iPhone_7Background2x43a75927()));
    Source(temp);
}
