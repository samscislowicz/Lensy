// This file was generated based on /Users/Sam/Desktop/Lensy/LensyFinal/build/iOS/Preview1/cache/ux11/Home.g.uno.
...
// {
// static Home() :7
static void Home__cctor_1_fn(uType* __type)
{
    Home::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 0);
...
static void Home_build(uType* type)
{
    ...
    ::STRINGS[94] = uString::Const("\n"
        ...
        "\t}\n"
        "");
    ::STRINGS[95] = uString::Const("Home.ux");
    ...
    type->SetFields(11,
        ...
        ::TYPES[0/*string[]*/], (uintptr_t)&::g::Home::__g_static_nametable1_, uFieldFlagsStatic);
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)Home__New2_fn, 0, true, type, 0));
}
...
::g::Fuse::AppBase_type* Home_typeof()
{
    ...
    type = (::g::Fuse::AppBase_type*)uClassType::New("Home", options);
    type->fp_build_ = Home_build;
    type->fp_ctor_ = (void*)Home__New2_fn;
    type->fp_cctor_ = Home__cctor_1_fn;
