// This file was generated based on /Users/Sam/Desktop/Lensy/LensyFinal/build/iOS/Preview1/cache/ux11/LensyV2.iPhone_7_Copy.Base_Buttons.Line.g.uno.
...
// public partial sealed class Line :4
// {
// static Line() :6
static void Line__cctor_3_fn(uType* __type)
{
}

static void Line_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)Line__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::Image_type* Line_typeof()
{
    ...
    options.ObjectSize = sizeof(Line);
    options.TypeSize = sizeof(::g::Fuse::Controls::Image_type);
    type = (::g::Fuse::Controls::Image_type*)uClassType::New("LensyV2.iPhone_7_Copy.Base_Buttons.Line", options);
    type->fp_build_ = Line_build;
    type->fp_ctor_ = (void*)Line__New4_fn;
    type->fp_cctor_ = Line__cctor_3_fn;
...
// public Line() :10
void Line__ctor_7_fn(Line* __this)
{
    __this->ctor_7();
}

// private void InitializeUX() :14
void Line__InitializeUX_fn(Line* __this)
{
    __this->InitializeUX();
}

// public Line New() :10
void Line__New4_fn(Line** __retval)
{
    *__retval = Line::New4();
}

// public Line() [instance] :10
void Line::ctor_7()
{
    uStackFrame __("LensyV2.iPhone_7_Copy.Base_Buttons.Line", ".ctor()");
    ctor_6();
    InitializeUX();
}

// private void InitializeUX() [instance] :14
void Line::InitializeUX()
{
    uStackFrame __("LensyV2.iPhone_7_Copy.Base_Buttons.Line", "InitializeUX()");
    ...
    temp1->Density(1.0f);
    temp1->File(::g::Uno::UX::BundleFileSource::New1(::g::LensyFinal_bundle::iPhone_7_CopyBase_ButtonsLine1x376ccc07()));
    temp2->Density(2.0f);
    temp2->File(::g::Uno::UX::BundleFileSource::New1(::g::LensyFinal_bundle::iPhone_7_CopyBase_ButtonsLine2x376cd00a()));
    Source(temp);
}

// public Line New() [static] :10
Line* Line::New4()
{
    Line* obj1 = (Line*)uNew(Line_typeof());
    obj1->ctor_7();
    return obj1;
}
// }
