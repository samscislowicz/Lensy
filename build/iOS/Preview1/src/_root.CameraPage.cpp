// This file was generated based on /Users/Sam/Desktop/Lensy/LensyFinal/build/iOS/Preview1/cache/ux11/CameraPage.g.uno.
...
static void CameraPage_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)CameraPage__New5_fn, 0, true, type, 1, ::g::Fuse::Navigation::Router_typeof()));
}
...
// public CameraPage(Fuse.Navigation.Router router) :9
...
// public CameraPage New(Fuse.Navigation.Router router) :9
void CameraPage__New5_fn(::g::Fuse::Navigation::Router* router1, CameraPage** __retval)
{
    *__retval = CameraPage::New5(router1);
}

// public CameraPage(Fuse.Navigation.Router router) [instance] :9
...
// public CameraPage New(Fuse.Navigation.Router router) [static] :9
