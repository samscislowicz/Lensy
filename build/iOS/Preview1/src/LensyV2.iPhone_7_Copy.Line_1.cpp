// This file was generated based on /Users/Sam/Desktop/Lensy/LensyFinal/build/iOS/Preview1/cache/ux11/LensyV2.iPhone_7_Copy.Line_1.g.uno.
...
// public partial sealed class Line_1 :4
// {
// static Line_1() :6
static void Line_1__cctor_3_fn(uType* __type)
{
}

static void Line_1_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)Line_1__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::Image_type* Line_1_typeof()
{
    ...
    options.ObjectSize = sizeof(Line_1);
    options.TypeSize = sizeof(::g::Fuse::Controls::Image_type);
    type = (::g::Fuse::Controls::Image_type*)uClassType::New("LensyV2.iPhone_7_Copy.Line_1", options);
    type->fp_build_ = Line_1_build;
    type->fp_ctor_ = (void*)Line_1__New4_fn;
    type->fp_cctor_ = Line_1__cctor_3_fn;
...
// public Line_1() :10
void Line_1__ctor_7_fn(Line_1* __this)
{
    __this->ctor_7();
}

// private void InitializeUX() :14
void Line_1__InitializeUX_fn(Line_1* __this)
{
    __this->InitializeUX();
}

// public Line_1 New() :10
void Line_1__New4_fn(Line_1** __retval)
{
    *__retval = Line_1::New4();
}

// public Line_1() [instance] :10
void Line_1::ctor_7()
{
    uStackFrame __("LensyV2.iPhone_7_Copy.Line_1", ".ctor()");
    ctor_6();
    InitializeUX();
}

// private void InitializeUX() [instance] :14
void Line_1::InitializeUX()
{
    uStackFrame __("LensyV2.iPhone_7_Copy.Line_1", "InitializeUX()");
    ...
    temp1->Density(1.0f);
    temp1->File(::g::Uno::UX::BundleFileSource::New1(::g::LensyFinal_bundle::iPhone_7_CopyLine_11xd98d503c()));
    temp2->Density(2.0f);
    temp2->File(::g::Uno::UX::BundleFileSource::New1(::g::LensyFinal_bundle::iPhone_7_CopyLine_12x53c4866b()));
    Source(temp);
}

// public Line_1 New() [static] :10
Line_1* Line_1::New4()
{
    Line_1* obj1 = (Line_1*)uNew(Line_1_typeof());
    obj1->ctor_7();
    return obj1;
}
// }
