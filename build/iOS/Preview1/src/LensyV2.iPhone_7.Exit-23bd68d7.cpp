// This file was generated based on /Users/Sam/Desktop/Lensy/LensyFinal/build/iOS/Preview1/cache/ux11/LensyV2.iPhone_7.Exit_Button.Oval.g.uno.
...
::g::Fuse::Controls::Image_type* Oval_typeof()
{
    ...
    type = (::g::Fuse::Controls::Image_type*)uClassType::New("LensyV2.iPhone_7.Exit_Button.Oval", options);
...
void Oval::ctor_7()
{
    uStackFrame __("LensyV2.iPhone_7.Exit_Button.Oval", ".ctor()");
    ctor_6();
    InitializeUX();
}
...
{
    uStackFrame __("LensyV2.iPhone_7.Exit_Button.Oval", "InitializeUX()");
    ...
    temp1->Density(1.0f);
    temp1->File(::g::Uno::UX::BundleFileSource::New1(::g::LensyFinal_bundle::iPhone_7Exit_ButtonOval1x3abcb99d()));
    temp2->Density(2.0f);
    temp2->File(::g::Uno::UX::BundleFileSource::New1(::g::LensyFinal_bundle::iPhone_7Exit_ButtonOval2x3abcb51e()));
    Source(temp);
}
...
}}}} // ::g::LensyV2::iPhone_7::Exit_Button
