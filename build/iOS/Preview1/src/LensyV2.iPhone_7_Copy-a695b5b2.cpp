// This file was generated based on /Users/Sam/Desktop/Lensy/LensyFinal/build/iOS/Preview1/cache/ux11/LensyV2.iPhone_7_Copy.Line_Copy_5.g.uno.
...
// public partial sealed class Line_Copy_5 :4
// {
// static Line_Copy_5() :6
static void Line_Copy_5__cctor_3_fn(uType* __type)
{
}

static void Line_Copy_5_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)Line_Copy_5__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::Image_type* Line_Copy_5_typeof()
{
    ...
    options.ObjectSize = sizeof(Line_Copy_5);
    options.TypeSize = sizeof(::g::Fuse::Controls::Image_type);
    type = (::g::Fuse::Controls::Image_type*)uClassType::New("LensyV2.iPhone_7_Copy.Line_Copy_5", options);
    type->fp_build_ = Line_Copy_5_build;
    type->fp_ctor_ = (void*)Line_Copy_5__New4_fn;
    type->fp_cctor_ = Line_Copy_5__cctor_3_fn;
...
// public Line_Copy_5() :10
void Line_Copy_5__ctor_7_fn(Line_Copy_5* __this)
{
    __this->ctor_7();
}

// private void InitializeUX() :14
void Line_Copy_5__InitializeUX_fn(Line_Copy_5* __this)
{
    __this->InitializeUX();
}

// public Line_Copy_5 New() :10
void Line_Copy_5__New4_fn(Line_Copy_5** __retval)
{
    *__retval = Line_Copy_5::New4();
}

// public Line_Copy_5() [instance] :10
void Line_Copy_5::ctor_7()
{
    uStackFrame __("LensyV2.iPhone_7_Copy.Line_Copy_5", ".ctor()");
    ctor_6();
    InitializeUX();
}

// private void InitializeUX() [instance] :14
void Line_Copy_5::InitializeUX()
{
    uStackFrame __("LensyV2.iPhone_7_Copy.Line_Copy_5", "InitializeUX()");
    ...
    temp1->Density(1.0f);
    temp1->File(::g::Uno::UX::BundleFileSource::New1(::g::LensyFinal_bundle::iPhone_7_CopyLine_Copy_51xf0783aa8()));
    temp2->Density(2.0f);
    temp2->File(::g::Uno::UX::BundleFileSource::New1(::g::LensyFinal_bundle::iPhone_7_CopyLine_Copy_52xf0783629()));
    Source(temp);
}

// public Line_Copy_5 New() [static] :10
Line_Copy_5* Line_Copy_5::New4()
{
    Line_Copy_5* obj1 = (Line_Copy_5*)uNew(Line_Copy_5_typeof());
    obj1->ctor_7();
    return obj1;
}
// }
