// This file was generated based on /Users/Sam/Desktop/Lensy/LensyFinal/build/iOS/Preview1/cache/ux11/Camera.g.uno.
...
// {
// static Camera() :7
static void Camera__cctor_1_fn(uType* __type)
{
    Camera::__g_static_nametable1_ = uArray::Init<uString*>(::TYPES[0/*string[]*/], 0);
...
static void Camera_build(uType* type)
{
    ...
    ::STRINGS[94] = uString::Const("\n"
        ...
        "  }\n"
        "");
    ::STRINGS[95] = uString::Const("Camera.ux");
    ::TYPES[0] = ::g::Uno::String_typeof()->Array();
    ::TYPES[1] = ::g::Uno::Collections::ICollection_typeof()->MakeType(::g::Fuse::Node_typeof(), NULL);
    type->SetInterfaces(
        ::g::Fuse::IProperties_typeof(), offsetof(::g::Fuse::AppBase_type, interface0));
    type->SetFields(11,
        ::g::Uno::UX::NameTable_typeof(), offsetof(::g::Camera, __g_nametable1), 0,
        ::TYPES[0/*string[]*/], (uintptr_t)&::g::Camera::__g_static_nametable1_, uFieldFlagsStatic);
...
::g::Fuse::AppBase_type* Camera_typeof()
{
    ...
    type = (::g::Fuse::AppBase_type*)uClassType::New("Camera", options);
    type->fp_build_ = Camera_build;
    type->fp_ctor_ = (void*)Camera__New2_fn;
    type->fp_cctor_ = Camera__cctor_1_fn;
...
// private void InitializeUX() :129
void Camera__InitializeUX_fn(Camera* __this)
{
    __this->InitializeUX();
}

// public Camera New() :125
void Camera__New2_fn(Camera** __retval)
{
    *__retval = Camera::New2();
}

uSStrong<uArray*> Camera::__g_static_nametable1_;

// public Camera() [instance] :125
void Camera::ctor_4()
{
    uStackFrame __("Camera", ".ctor()");
    ctor_3();
    InitializeUX();
}

// private void InitializeUX() [instance] :129
void Camera::InitializeUX()
{
    uStackFrame __("Camera", "InitializeUX()");
