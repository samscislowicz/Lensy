// This file was generated based on /Users/Sam/Desktop/Lensy/LensyFinal/build/iOS/Preview1/cache/ux11/LensyV2.iPhone_7_Copy.Aperture_Ring.g.uno.
...
// public partial sealed class Aperture_Ring :4
// {
// static Aperture_Ring() :6
static void Aperture_Ring__cctor_3_fn(uType* __type)
{
}

static void Aperture_Ring_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)Aperture_Ring__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::Image_type* Aperture_Ring_typeof()
{
    ...
    options.ObjectSize = sizeof(Aperture_Ring);
    options.TypeSize = sizeof(::g::Fuse::Controls::Image_type);
    type = (::g::Fuse::Controls::Image_type*)uClassType::New("LensyV2.iPhone_7_Copy.Aperture_Ring", options);
    type->fp_build_ = Aperture_Ring_build;
    type->fp_ctor_ = (void*)Aperture_Ring__New4_fn;
    type->fp_cctor_ = Aperture_Ring__cctor_3_fn;
...
// public Aperture_Ring() :10
void Aperture_Ring__ctor_7_fn(Aperture_Ring* __this)
{
    __this->ctor_7();
}

// private void InitializeUX() :14
void Aperture_Ring__InitializeUX_fn(Aperture_Ring* __this)
{
    __this->InitializeUX();
}

// public Aperture_Ring New() :10
void Aperture_Ring__New4_fn(Aperture_Ring** __retval)
{
    *__retval = Aperture_Ring::New4();
}

// public Aperture_Ring() [instance] :10
void Aperture_Ring::ctor_7()
{
    uStackFrame __("LensyV2.iPhone_7_Copy.Aperture_Ring", ".ctor()");
    ctor_6();
    InitializeUX();
}

// private void InitializeUX() [instance] :14
void Aperture_Ring::InitializeUX()
{
    uStackFrame __("LensyV2.iPhone_7_Copy.Aperture_Ring", "InitializeUX()");
    ...
    temp1->Density(1.0f);
    temp1->File(::g::Uno::UX::BundleFileSource::New1(::g::LensyFinal_bundle::iPhone_7_CopyAperture_Ring1xc03e97cd()));
    temp2->Density(2.0f);
    temp2->File(::g::Uno::UX::BundleFileSource::New1(::g::LensyFinal_bundle::iPhone_7_CopyAperture_Ring2xc03eac50()));
    Source(temp);
}

// public Aperture_Ring New() [static] :10
Aperture_Ring* Aperture_Ring::New4()
{
    Aperture_Ring* obj1 = (Aperture_Ring*)uNew(Aperture_Ring_typeof());
    obj1->ctor_7();
    return obj1;
}
// }
