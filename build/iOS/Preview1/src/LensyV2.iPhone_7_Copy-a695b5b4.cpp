// This file was generated based on /Users/Sam/Desktop/Lensy/LensyFinal/build/iOS/Preview1/cache/ux11/LensyV2.iPhone_7_Copy.Line_Copy_3.g.uno.
...
// public partial sealed class Line_Copy_3 :4
// {
// static Line_Copy_3() :6
static void Line_Copy_3__cctor_3_fn(uType* __type)
{
}

static void Line_Copy_3_build(uType* type)
{
    ...
    type->Reflection.SetFunctions(1,
        new uFunction(".ctor", NULL, (void*)Line_Copy_3__New4_fn, 0, true, type, 0));
}

::g::Fuse::Controls::Image_type* Line_Copy_3_typeof()
{
    ...
    options.ObjectSize = sizeof(Line_Copy_3);
    options.TypeSize = sizeof(::g::Fuse::Controls::Image_type);
    type = (::g::Fuse::Controls::Image_type*)uClassType::New("LensyV2.iPhone_7_Copy.Line_Copy_3", options);
    type->fp_build_ = Line_Copy_3_build;
    type->fp_ctor_ = (void*)Line_Copy_3__New4_fn;
    type->fp_cctor_ = Line_Copy_3__cctor_3_fn;
...
// public Line_Copy_3() :10
void Line_Copy_3__ctor_7_fn(Line_Copy_3* __this)
{
    __this->ctor_7();
}

// private void InitializeUX() :14
void Line_Copy_3__InitializeUX_fn(Line_Copy_3* __this)
{
    __this->InitializeUX();
}

// public Line_Copy_3 New() :10
void Line_Copy_3__New4_fn(Line_Copy_3** __retval)
{
    *__retval = Line_Copy_3::New4();
}

// public Line_Copy_3() [instance] :10
void Line_Copy_3::ctor_7()
{
    uStackFrame __("LensyV2.iPhone_7_Copy.Line_Copy_3", ".ctor()");
    ctor_6();
    InitializeUX();
}

// private void InitializeUX() [instance] :14
void Line_Copy_3::InitializeUX()
{
    uStackFrame __("LensyV2.iPhone_7_Copy.Line_Copy_3", "InitializeUX()");
    ...
    temp1->Density(1.0f);
    temp1->File(::g::Uno::UX::BundleFileSource::New1(::g::LensyFinal_bundle::iPhone_7_CopyLine_Copy_31xf07721e6()));
    temp2->Density(2.0f);
    temp2->File(::g::Uno::UX::BundleFileSource::New1(::g::LensyFinal_bundle::iPhone_7_CopyLine_Copy_32xf0770d63()));
    Source(temp);
}

// public Line_Copy_3 New() [static] :10
Line_Copy_3* Line_Copy_3::New4()
{
    Line_Copy_3* obj1 = (Line_Copy_3*)uNew(Line_Copy_3_typeof());
    obj1->ctor_7();
    return obj1;
}
// }
