namespace LensyV2.iPhone_7_Copy
{
    ...
    public partial class Line: Fuse.Controls.Image
    {
        ...
        void InitializeUX()
        {
            ...
            temp1.Density = 1f;
            temp1.File = new global::Uno.UX.BundleFileSource(import global::Uno.IO.BundleFile("../../../LensyV2.sketch-assets/iPhone_7_Copy.Line@1x.png"));
            temp2.Density = 2f;
            temp2.File = new global::Uno.UX.BundleFileSource(import global::Uno.IO.BundleFile("../../../LensyV2.sketch-assets/iPhone_7_Copy.Line@2x.png"));
            this.Source = temp;
        }
    }
}
